...
plt.plot(ODEf['Time'][::2], ODEf['ODEV'][::2],'.',color='#6600FF',markersize=6,label='ODE')
plt.plot(T,np.mean(V,1),color='#6600FF',linewidth = 3.0,label='ABM')
...
plt.plot(ODEf['Time'][::2], ODEf['ODEH'][::2],'.',color='#339900',markersize=6,label='ODE')
plt.plot(T,np.mean(H,1),color='#339900',linewidth = 3.0,label='ABM')
...
for r in range(1,21):
    ...
    # plt.plot(T, f['CC3DIFNe_Scalar'],'--', color='#993300', linewidth=2.0, alpha=0.15)
plt.plot(ODEf['Time'][::2], ODEf['ODEIFNe'][::2],'.',color='#993300',markersize=6,label='ODE')
plt.plot(T,np.mean(IFNe,1),color='#993300',linewidth = 3.0,label='ABM_Field')
# plt.plot(T,np.mean(IFNe_Scalar,1),'--', color='#993300',linewidth = 3.0,label='ABM_Scalar')
...
plt.plot(ODEf['Time'][::2], ODEf['ODESTATP'][::2],'.',color='#0033FF',markersize=6,label='ODE')
plt.plot(T,np.mean(STATP,1),color='#0033FF',linewidth = 3.0,label='ABM')
plt.title('STATP')
plt.xlabel('Time (hrs)')
...
plt.plot(ODEf['Time'][::2], ODEf['ODEIRF7'][::2],'.',color='#FF6600',markersize=6,label='ODE')
plt.plot(T,np.mean(IRF7,1),color='#FF6600',linewidth = 3.0,label='ABM')
plt.title('IRF7')
plt.xlabel('Time (hrs)')
...
plt.plot(ODEf['Time'][::2], ODEf['ODEIRF7P'][::2],'.',color='#666666',markersize=6,label='ODE')
plt.plot(T,np.mean(IRF7P,1),color='#666666',linewidth = 3.0,label='ABM')
plt.title('IRF7P')
plt.xlabel('Time (hrs)')
...
plt.plot(ODEf['Time'][::2], ODEf['ODEIFN'][::2],'.',color='#CC0033',markersize=6,label='ODE')
plt.plot(T,np.mean(IFN,1),color='#CC0033',linewidth = 3.0,label='ABM')
plt.title('IFN')
plt.xlabel('Time (hrs)')
