...
//parameters
E0=5.0*10^5; aE=5.0*10^-2; bE=2*10^-5; dE=10^-3;
kE=1.19*10^-2; g=0.15; tC=0.5;
pV=1.9; cV=1;
D0=10^3; bD=10^-2; dD=2.9;
kD=0.5; tD=10; dDm=0.5;
dc=1.5*10^-3; Tc0=1*10^3; pT1=2.7; pT2=600; dT1=2; dT2=1;
s1=1.1; p1=2; d1=0.1; m=0.25;
s2=0.1; p2=0.01; ro=0.5;
